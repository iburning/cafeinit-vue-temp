<template>
  <ci-tab-bar v-ref:my-tab-bar></ci-tab-bar>
</template>
...
export default {
  data() {
    return {
      // tabBarItems: [
      //   { text: 'Tab A' },
      //   { text: 'Tab B', path: '/home' },
      //   { text: 'Tab C', path: '//user' }
      // ]
      tabBarItems: [
  ...
  ready() {
    ...
    this.$refs.myTabBar.$on('on_item_click', function (index) {
      console.log('myTabBar on_item_click', index)
    })
  }
}
</script>
